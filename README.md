...
| Image                | belongsTo(User), hasMany(MerchantCategoryMain), hasMany(Merchant)                                                                   | id, filename, url, user_id, width, height, size, mime_type, timespace                                                                               |
| MerchantCategory     | belongsTo(Merchant), belongsTo(MerchantCategoryMain)                                                                                | merchant_id, category_id                                                                                                                            |
| MerchantCategoryMain | belongsToMany(ProductCategory), belongsTo(Image)                                                                                    | id, name, img (abandoned), description, image_id                                                                                                    |
| Menu                 | belongsTo(Merchant), hasMany(Product)                                                                                               | id, name, description, merchant_id                                                                                                                  |
| Product              | belongsTo(Menu), hasMany(ProductImage), belongsToMany(ProductCategory), belongsToMany(ProductOption)                                | id, name, description, price, menu_id                                                                                                               |
| ProductImage         | belongsTo(Product),belongsTo(Image)                                                                                                 | id, product_id, image_url, title, description                                                                                                       |
...
| ProductCategoryMain  | belongsToMany(ProductCategory)                                                                                                      | id, name, description, img                                                                                                                          |
| Option_Category      | belongsTo(Option), belongsTo(OptionCategoryMain) (junction table)                                                                   | id, option_id, option_category_main_id, created_at, updated_at                                                                                      |
| OptionCategoryMain   | hasMany(OptionCategory)                                                                                                             | id, name, description, created_at, updated_at                                                                                                       |
