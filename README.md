...
| Model                    | Table                     | Fields                                                                                                                                                                                                                         |
| ------------------------ | ------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **User**                 | users                     | id(UUID), name, email, password, phoneNumber, address(text), role(enum: customer, merchant, admin), created\_at(timestamptz), updated\_at(timestamptz)                                                                         |
| **Admin**                | admins                    | id(UUID), user\_id(UUID), created\_at(timestamptz), updated\_at(timestamptz)                                                                                                                                                   |
| **Merchant**             | merchants                 | id(UUID), user\_id(UUID), business\_name, description, feature(text), merchant\_logo(abandoned), location(json or text), image\_id(UUID), business\_hours(json), created\_at(timestamptz), updated\_at(timestamptz)            |
| **Image**                | images                    | id(UUID), filename, url, user\_id(UUID), width(int), height(int), size(int), mime\_type(string), created\_at(timestamptz), updated\_at(timestamptz)                                                                            |
| **MerchantCategory**     | merchant\_categories      | id(UUID), merchant\_id(UUID), category\_id(UUID)                                                                                                                                                                               |
| **MerchantCategoryMain** | merchant\_category\_mains | id(UUID), name, description, image\_id(UUID), created\_at(timestamptz), updated\_at(timestamptz)                                                                                                                               |
| **Menu**                 | menus                     | id(UUID), name, description, merchant\_id(UUID), created\_at(timestamptz), updated\_at(timestamptz)                                                                                                                            |
| **Product**              | products                  | id(UUID), name, description, price(float), menu\_id(UUID), created\_at(timestamptz), updated\_at(timestamptz)                                                                                                                  |
| **ProductImage**         | product\_images           | id(UUID), product\_id(UUID), image\_id(UUID), sort\_order(int), is\_main(boolean, default: false), created\_at(timestamptz), updated\_at(timestamptz)                                                                          |
| **ProductOption**        | product\_options          | id(UUID), product\_id(UUID), option\_id(UUID), required(boolean), sort\_order(int), created\_at(timestamptz), updated\_at(timestamptz)                                                                                         |
| **Option**               | options                   | id(UUID), name, type(enum: select, checkbox, text, number), description(text), min\_select(int), max\_select(int), user\_id(UUID), merchant\_id(UUID), is\_global(boolean), created\_at(timestamptz), updated\_at(timestamptz) |
| **OptionValue**          | option\_values            | id(UUID), option\_id(UUID), value(string), extra\_price(float), is\_default(boolean), sort\_order(int), created\_at(timestamptz), updated\_at(timestamptz)                                                                     |
| **ProductCategory**      | product\_categories       | id(UUID), product\_id(UUID), category\_id(UUID)                                                                                                                                                                                |
| **ProductCategoryMain**  | product\_category\_mains  | id(UUID), name, description, image\_id(UUID), created\_at(timestamptz), updated\_at(timestamptz)                                                                                                                               |
| **OptionCategory**       | option\_categories        | id(UUID), option\_id(UUID), option\_category\_main\_id(UUID)                                                                                                                                                                   |
| **OptionCategoryMain**   | option\_category\_mains   | id(UUID), name, description, created\_at(timestamptz), updated\_at(timestamptz)                                                                                                                                                |
